    ...
    EYE.extend({
        ...
        spacegallery: {
            ...
            defaults: {
                ...
                minScale: 1, // minimum scale for the image in the back
            ...
            positionImages: function(el) {
                ...
                $(el)
                    ...
                    .removeAttr('height')
                    .each(function(nr){
                        var newWidth = this.spacegallery.origWidth - (this.spacegallery.origWidth - this.spacegallery.origWidth * el.spacegalleryCfg.minScale) * el.spacegalleryCfg.asins[nr] + 100;
                        $(this)
                            .css({
                                top: el.spacegalleryCfg.tops[nr] + 'px',
                                marginLeft: - parseInt(((newWidth + el.spacegalleryCfg.border)/2) + ((nr+1)*10	), 10) + 'px',
                                ...
                                $('img', this)
                                    .each(function(nr){
                                        ...
                                        if (nr + 1 == el.spacegalleryCfg.images) {
                                            ...
                                            newWidth = this.spacegallery.origWidth - (this.spacegallery.origWidth - this.spacegallery.origWidth * el.spacegalleryCfg.minScale) * next + 100;
                                            $(this).css({
